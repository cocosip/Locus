    ...
    public class FileWatcherAutoManager : IFileWatcherAutoManager
    {
        ...
        private async Task<int> CreateMultiTenantWatchersAsync(FileWatcherRootConfiguration rootConfig, CancellationToken ct = default)
        {
            ...
            var watcherConfig = new FileWatcherConfiguration
            {
                ...
                AutoCreateTenantDirectoriesCacheTtl = rootConfig.AutoCreateTenantDirectoriesCacheTtl,
                ...
                SourceCleanupFailureDirectory = rootConfig.SourceCleanupFailureDirectory,
